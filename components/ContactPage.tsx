...
<div className="w-full md:w-[628px] bg-[#0B1C14] rounded-[10px] border border-[#000] p-[24px] 
  ...
  <div className="flex flex-col gap-[24px]">
    ...
    <p className="text-[20px] leading-[140%] font-[400] mt[20px] text-[#CAF476]">
      Falls deine Frage offen bleibt: <br/>
      Füll einfach das Formular mit ein paar Infos zu deinem Anliegen aus. <br/>
      Wir prüfen deine Nachricht und melden uns mit dem nächsten passenden Schritt bei dir.
    </p>
  </div>
  ...
  <div className="h-[1px]"></div>
      ...
      {/* ===== FORM + CALL ===== */}
      <div className="flex flex-col lg:flex-row justify-center items-start w-full max-w-[1300px] gap-[60px] md:gap-[108px] mx-auto mt-[100px] md:mt-[160px] px-[40px] md:px-[10px]">

        {/* LEFT SIDE – FORM */}
        <div className="flex flex-col w-full max-w-[700px] gap-[24px]">
          <div className="relative">
            <span className="block md:absolute md:-top-[80px] left-0 text-[#132219] text-[32px] md:text-[48px] font-[500] leading-[100%] tracking-[-0.48px] mb-2 md:mb-0">
              Fragen?
            </span>
          ...
          <form className="flex flex-col gap-[16px]">
            ...
            <div className="relative">
              <select className="w-full h-[50px] border border-[#132219] rounded-full px-6 text-[16px] font-medium text-[#132219]/70 bg-white outline-none appearance-none">
                <option>Thema deiner Anfrage</option>
